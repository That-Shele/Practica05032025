...
namespace Practica05032025.AppMVCDataFirst.Controllers
{
    public class ServicioController : Controller
    {
        ...
        public ServicioController(CatalogosDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Descripcion")] Servicio servicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Descripcion")] Servicio servicio)
        {
            if (id != servicio.Id)
            {
                return NotFound();
